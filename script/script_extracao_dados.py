...
# eth.src==     || (eth.src==)
ip_filter['Ligth'] = "'tcp && (eth.src==d0:73:d5:01:83:08)'"                        #ok
ip_filter['Plug'] = "'tcp && (eth.src==ec:1a:59:79:f4:89) || (eth.src==50:c7:bf:00:56:39)'"  #ok
ip_filter['Camera'] = "'tcp && (eth.src==70:ee:50:18:34:43) || (eth.src==f4:f2:6d:93:51:f1) || (eth.src==00:16:6c:ab:6b:88)  || (eth.src==30:8c:fb:2f:e4:b2)  || (eth.src==00:62:6e:51:27:2e)  || (eth.src==e8:ab:fa:19:de:4f)  || (eth.src==00:24:e4:11:18:a8)  || (eth.src==30:8c:fb:b6:ea:45)'"      #ok
ip_filter['Assist'] = "'tcp && (eth.src==44:65:0d:56:cc:d3)'"       #ok
ip_filter['Sensor'] = "'tcp && (eth.src==ec:1a:59:83:28:11) || (eth.src==18:b4:30:25:be:e4) || (eth.src==70:ee:50:03:b8:ac) || (eth.src==00:24:e4:1b:6f:96) || (eth.src==74:6a:89:00:2e:25) || (eth.src==00:24:e4:20:28:c6)'"  #ok
ip_filter['SmartHome'] = "'tcp && (eth.src==d0:52:a8:00:67:5e) || (eth.src==74:c6:3b:29:d7:1d) || (eth.src==18:b7:9e:02:20:44) || (eth.src==e0:76:d0:33:bb:85)'"    #ok
ip_filter['SmartPhones'] = "'tcp && (eth.src==08:21:ef:3b:fc:e3) || (eth.src==40:f3:08:ff:1e:da) || (eth.src==b4:ce:f6:a7:a3:c2) || (eth.src==d0:a6:37:df:a1:e1)'"  #ok
ip_filter['PC'] = "'tcp && (eth.src==74:2f:68:81:69:42) || (eth.src==ac:bc:32:d4:6f:2f)'"  #ok
ip_filter['Printer'] = "'tcp && (eth.src==70:5a:0f:e4:9b:c0) '"  #ok
...
lable_feature = open("../pcap_tensor/lable_feature_IOT.csv",'a')
